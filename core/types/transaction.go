...
var (
	...
	ErrInvalidbBecomeCandidateBalance = errors.New("invalid transaction become candidate and out of balance")
)
...
func (tx *Transaction) Validate() error {
	// spew.Dump("Validate", tx.Type())
	if tx.Type() != Binary {
		// return errors.New("transaction type must be 0")
