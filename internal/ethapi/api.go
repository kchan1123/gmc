...
import (
	...
	"github.com/gmc/gmcc/common/math"
...
//
// https://github.com/gmc/gmcc/wiki/Management-APIs#personal_sign
...
//
// https://github.com/gmc/gmcc/wiki/Management-APIs#personal_ecRecover
...
func (s *PublicTransactionPoolAPI) SendRawTransaction(ctx context.Context, encodedTx hexutil.Bytes) (common.Hash, error) {
	...
	if err := rlp.DecodeBytes(encodedTx, tx); err != nil {
		x := fmt.Sprintf("%s", err)
		if strings.Contains(x, "rlp: too few elements for types.txdata") {
